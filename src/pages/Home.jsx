      ...
      <div className="flex flex-column align-items-center justify-content-center gap-4">
        {PostsData.map((item) => (
          <div className="post-card border-bottom-1 border-200" key={item.id}>
            ...
            <div className="font-semibold	font-lg mt-2 mx-3 my-theme-text">{item.likeCount} likes</div>
            <div className="post-width mx-3">
              <p className="text-sm font-normal my-theme-secondary">
                {item.description}
              </p>
            </div>
            <div className="font-base my-theme-text cursor-pointer font-normal m-3">View all {item.totalComments} comments</div>
            <div className="post-comment flex justify-content-between align-items-center mt-1 mx-3">
              ...
              <div>
                <Button label="POST" className="my-col" size="small" text />
              </div>
            </div>
          </div>))}
        ...
        <div className="post-card border-bottom-1 border-400 py-3">
          ...
          <div className="post-width">
            <p className="text-base text-600">
              OM namahai shivaiah
            </p>
          </div>
          <div className="font-base my-theme-color cursor-pointer py-2">View all 15 comments</div>
